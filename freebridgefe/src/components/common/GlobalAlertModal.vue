...
<template>
  <Teleport to="body">
    ...
    >
      <div class="fb-modal-surface w-full max-w-md rounded-[28px] backdrop-blur-2xl">
        <div class="p-6">
          ...
          <h3 class="mt-4 text-xl font-semibold text-slate-950">{{ alertStore.title }}</h3>
          <p class="mt-3 whitespace-pre-line text-sm leading-relaxed text-slate-500">{{ alertStore.message }}</p>
        </div>
