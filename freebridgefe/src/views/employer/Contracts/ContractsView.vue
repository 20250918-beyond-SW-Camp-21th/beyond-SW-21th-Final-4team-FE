        ...
        <div v-motion :initial="{ opacity: 0, y: 20 }" :enter="{ opacity: 1, y: 0 }" class="mb-8">
            <div class="flex items-center justify-between flex-wrap gap-4 mb-3">
                ...
                <button
                    ...
                    class="px-5 py-3 bg-blue-500 rounded-xl text-white font-semibold flex items-center gap-2 shadow-lg"
                    v-motion
                    :hover="{ scale: 1.05 }"
                    :tap="{ scale: 0.95 }"
                >
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                ...
                <div class="relative flex items-center gap-3">
                    <button
                        type="button"
                        @click="resetFilters"
                        class="px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white/70 hover:text-white hover:bg-white/10 transition-colors text-sm"
                    >
                        필터 초기화
                    </button>
                    <button
