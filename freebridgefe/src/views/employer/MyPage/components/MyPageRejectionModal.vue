...
import type { Application } from '@/api/MyPage/employer';
...
<template>
  <div class="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4 font-sans text-left">
    <div 
